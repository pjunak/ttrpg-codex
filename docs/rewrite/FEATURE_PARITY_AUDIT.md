...
| F13 | Clean sheet printing/PDF | High for physical tables and fallback | Print a saved revision through shared presentation | Medium after foundation |
| F14 | Reviewed sheet import and undo | High | Current-format replacement as a reversible revision | Medium after foundation |
...
| F16 | Attunement capacity feedback | High, focused play aid | Derived eligibility/capacity with explicit DM exceptions | Shared play slice |
| F17 | Character decisions and reconciliation | Foundational | Reversible history, derived results, DM grants and rules adoption | Large, coordinated |
| F18 | Rule details and calculation explanations | Foundational and useful at the table | Shared details popovers across all rule-related surfaces | Large, coordinated |
| F19 | Senses display | High, focused play aid | Shared derived traits with units, conditions and provenance | Shared play slice |
| F20 | HP range behavior | High, focused correctness fix | One rules-owned bounds policy and reviewed maximum changes | Shared play slice |
