...
[`ADR-0002`](decisions/0002-reviewed-import-deletes.md). Unified Import
Center routing is governed by
[`ADR-0003`](decisions/0003-format-routed-import-center.md).
...
| `pantheon`, `artifacts` | Standard entity arrays. | Reference / world-building collections. (Species was removed from the base app — D&D 2024 species ship in the `dnd-2024-compendium` addon; `character.species` is now a free-text string.) |
