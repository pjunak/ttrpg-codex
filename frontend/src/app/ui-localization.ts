...
const enCatalog = {
  ...
  "graph.keyboardHelp": "Tab to a character and press Enter to open it. Arrow keys move the focused card; Shift moves farther. Arrow keys on the canvas pan. Escape cancels a drag. Shift+F10 opens character actions.",
...
const csCatalog = {
  ...
  "graph.keyboardHelp": "Tabulátorem vyberte postavu a Enterem ji otevřete. Šipky přesouvají vybranou kartu, se Shiftem dále. Šipky na plátně posouvají pohled. Escape zruší přesun. Shift+F10 otevře akce postavy.",
