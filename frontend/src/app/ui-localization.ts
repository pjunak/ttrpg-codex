...
const enCatalog = {
  ...
  "graph.storageChanged": "Another tab changed the arrangement. The current drag was cancelled and the saved view was loaded.",
  "graph.retry": "Retry",
...
const csCatalog = {
  ...
  "graph.storageChanged": "Jiná karta změnila rozložení. Přesun byl zrušen a načetlo se uložené zobrazení.",
